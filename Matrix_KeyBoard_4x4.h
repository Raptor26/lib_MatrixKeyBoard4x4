...
// Состояния автомата обработки матричной клавиатуры
...
// Состояния в которых могут находится виртуальные таймеры
...
typedef struct {
    ...
    void (*OutSet[4])(void); //             Массив указателей на функции, устанавливающий "HIGH" на выводах 0-3
    void (*OutReSet[4])(void); //           Массив указателей на функции, устанавливающий "LOW" на выводах 0-3

    // Массив указателей на функцию, возвращающую тип uint16_t
    uint16_t(*In[4])(void); //              Указатель на функцию, считавыющий состояние выводов с 4-7
